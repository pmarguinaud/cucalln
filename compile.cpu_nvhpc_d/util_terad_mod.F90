...
READ (KLUN) ZTMP0
YD%RMINICE = ZTMP0
ALLOCATE (ZTMP1, MOLD=YD%RVOLCSPEC)
READ (KLUN) ZTMP1
YD%RVOLCSPEC = ZTMP1
DEALLOCATE (ZTMP1)
READ (KLUN) ZTMP0
...
IF (LCVDAESS) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%CVDAESS)
  READ (KLUN) ZTMP1
  YD%CVDAESS = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LCVDAEDU) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%CVDAEDU)
  READ (KLUN) ZTMP1
  YD%CVDAEDU = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LCVDAEOM) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%CVDAEOM)
  READ (KLUN) ZTMP1
  YD%CVDAEOM = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LCVDAEBC) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%CVDAEBC)
  READ (KLUN) ZTMP1
  YD%CVDAEBC = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LCVDAESU) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%CVDAESU)
  READ (KLUN) ZTMP1
  YD%CVDAESU = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
