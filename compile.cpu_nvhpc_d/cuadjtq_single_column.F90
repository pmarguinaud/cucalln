...
#endif
SUBROUTINE CUADJTQ_SINGLE_COLUMN (YDTHF, YDCST, YDEPHLI, KIDIA, KFDIA, KLON&
&, KLEV, KK, PSP, PT, PQ, LDFLAG, KCALL, LDOFLAG, LDEBUG, YDSTACK)
...
IF (LLDEBUG)  THEN
    WRITE (*,'(" CUADJTQ 116 ",E30.20)') PT (JLON, 12)
ENDIF
