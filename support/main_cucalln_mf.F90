...
ALLOCATE (PTENT_OUT(NPROMA1,KLEV))
ALLOCATE (PTENQ_OUT(NPROMA1,KLEV))
ALLOCATE (PTENU_OUT(NPROMA1,KLEV))
ALLOCATE (PTENV_OUT(NPROMA1,KLEV))
ALLOCATE (PTENC_OUT(NPROMA1,KLEV,KTRAC))
ALLOCATE (PARPRC_OUT(NPROMA1))
ALLOCATE (KTOPC_OUT(NPROMA1))
ALLOCATE (KBASEC_OUT(NPROMA1))
ALLOCATE (KTYPE_OUT(NPROMA1))
ALLOCATE (KCBOT_OUT(NPROMA1))
ALLOCATE (KCTOP_OUT(NPROMA1))
ALLOCATE (KBOTSC_OUT(NPROMA1))
ALLOCATE (LDCUM_OUT(NPROMA1))
ALLOCATE (LDSC_OUT(NPROMA1))
ALLOCATE (PLU_OUT(NPROMA1,KLEV))
ALLOCATE (PLUDE_OUT(NPROMA1,KLEV))
ALLOCATE (PLUDELI_OUT(NPROMA1,KLEV,4))
ALLOCATE (PSNDE_OUT(NPROMA1,KLEV,2))
ALLOCATE (PMFU_OUT(NPROMA1,KLEV))
ALLOCATE (PMFD_OUT(NPROMA1,KLEV))
ALLOCATE (PDIFCQ_OUT(NPROMA1,KLEV+1))
ALLOCATE (PDIFCS_OUT(NPROMA1,KLEV+1))
ALLOCATE (PFHPCL_OUT(NPROMA1,KLEV+1))
ALLOCATE (PFHPCN_OUT(NPROMA1,KLEV+1))
ALLOCATE (PFPLCL_OUT(NPROMA1,KLEV+1))
ALLOCATE (PFPLCN_OUT(NPROMA1,KLEV+1))
ALLOCATE (PLRAIN_OUT(NPROMA1,KLEV))
ALLOCATE (PRSUD_OUT(NPROMA1,KLEV,2))
ALLOCATE (PSTRCU_OUT(NPROMA1,KLEV+1))
ALLOCATE (PSTRCV_OUT(NPROMA1,KLEV+1))
ALLOCATE (PFCQLF_OUT(NPROMA1,KLEV+1))
ALLOCATE (PFCQIF_OUT(NPROMA1,KLEV+1))
ALLOCATE (PMFUDE_RATE_OUT(NPROMA1,KLEV))
ALLOCATE (PMFDDE_RATE_OUT(NPROMA1,KLEV))
ALLOCATE (PCAPE_OUT(NPROMA1))
ALLOCATE (PWMEAN_OUT(NPROMA1))
ALLOCATE (PDISS_OUT(NPROMA1,KLEV))
...
ALLOCATE (LDLAND_1(NPROMA1,NGPBLKS1))
ALLOCATE (PLCRIT_AER_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PTM1_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PQM1_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PUM1_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PVM1_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PCM1_1(NPROMA1,KLEV,KTRAC,NGPBLKS1))
ALLOCATE (PLITOT_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PVERVEL_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PQHFL_1(NPROMA1,KLEV+1,NGPBLKS1))
ALLOCATE (PAHFS_1(NPROMA1,KLEV+1,NGPBLKS1))
ALLOCATE (PAPHM1_1(NPROMA1,KLEV+1,NGPBLKS1))
ALLOCATE (PAP_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PAPH_1(NPROMA1,KLEV+1,NGPBLKS1))
ALLOCATE (PGEO_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PGEOH_1(NPROMA1,KLEV+1,NGPBLKS1))
ALLOCATE (PTENT_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PTENQ_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PTENU_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PTENV_1(NPROMA1,KLEV,NGPBLKS1))
ALLOCATE (PGAW_1(NPROMA1,NGPBLKS1))
ALLOCATE (PCUCONVCA_1(NPROMA1,NGPBLKS1))
ALLOCATE (PGP2DSPP_1(NPROMA1,KSPPN2D,NGPBLKS1))
ALLOCATE (PDX_1(NPROMA1,NGPBLKS1))
ALLOCATE (PTENC_1(NPROMA1,KLEV,KTRAC,NGPBLKS1))
ALLOCATE (LDSHCV_1(NPROMA1,NGPBLKS1))
...
READ (ILUN) LDLAND_1            ; CALL YDD%SHUFFLE (LDLAND_1          , LDLAND      )
READ (ILUN) PLCRIT_AER_1        ; CALL YDD%SHUFFLE (PLCRIT_AER_1      , PLCRIT_AER  )
READ (ILUN) PTM1_1              ; CALL YDD%SHUFFLE (PTM1_1            , PTM1        )
READ (ILUN) PQM1_1              ; CALL YDD%SHUFFLE (PQM1_1            , PQM1        )
READ (ILUN) PUM1_1              ; CALL YDD%SHUFFLE (PUM1_1            , PUM1        )
READ (ILUN) PVM1_1              ; CALL YDD%SHUFFLE (PVM1_1            , PVM1        )
READ (ILUN) PCM1_1              ; CALL YDD%SHUFFLE (PCM1_1            , PCM1        )
READ (ILUN) PLITOT_1            ; CALL YDD%SHUFFLE (PLITOT_1          , PLITOT      )
READ (ILUN) PVERVEL_1           ; CALL YDD%SHUFFLE (PVERVEL_1         , PVERVEL     )
READ (ILUN) PQHFL_1             ; CALL YDD%SHUFFLE (PQHFL_1           , PQHFL       )
READ (ILUN) PAHFS_1             ; CALL YDD%SHUFFLE (PAHFS_1           , PAHFS       )
READ (ILUN) PAPHM1_1            ; CALL YDD%SHUFFLE (PAPHM1_1          , PAPHM1      )
READ (ILUN) PAP_1               ; CALL YDD%SHUFFLE (PAP_1             , PAP         )
READ (ILUN) PAPH_1              ; CALL YDD%SHUFFLE (PAPH_1            , PAPH        )
READ (ILUN) PGEO_1              ; CALL YDD%SHUFFLE (PGEO_1            , PGEO        )
READ (ILUN) PGEOH_1             ; CALL YDD%SHUFFLE (PGEOH_1           , PGEOH       )
READ (ILUN) PTENT_1             ; CALL YDD%SHUFFLE (PTENT_1           , PTENT       )
READ (ILUN) PTENQ_1             ; CALL YDD%SHUFFLE (PTENQ_1           , PTENQ       )
READ (ILUN) PTENU_1             ; CALL YDD%SHUFFLE (PTENU_1           , PTENU       )
READ (ILUN) PTENV_1             ; CALL YDD%SHUFFLE (PTENV_1           , PTENV       )
READ (ILUN) PGAW_1              ; CALL YDD%SHUFFLE (PGAW_1            , PGAW        )
READ (ILUN) PCUCONVCA_1         ; CALL YDD%SHUFFLE (PCUCONVCA_1       , PCUCONVCA   )
READ (ILUN) PGP2DSPP_1          ; CALL YDD%SHUFFLE (PGP2DSPP_1        , PGP2DSPP    )
READ (ILUN) PDX_1               ; CALL YDD%SHUFFLE (PDX_1             , PDX         )
READ (ILUN) PTENC_1             ; CALL YDD%SHUFFLE (PTENC_1           , PTENC       )
READ (ILUN) LDSHCV_1            ; CALL YDD%SHUFFLE (LDSHCV_1          , LDSHCV      )
CLOSE (ILUN)
