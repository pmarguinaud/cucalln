...
CONTAINS
  ...
  GENERIC :: SHUFFLE => SHUFFLE2L, SHUFFLE2P, SHUFFLE3P, SHUFFLE4P
  PROCEDURE :: SHUFFLE2L 
  PROCEDURE :: SHUFFLE2P 
  PROCEDURE :: SHUFFLE3P
  PROCEDURE :: SHUFFLE4P
...
DO JBLK2 = 1, SELF%IGPBLKS2
  DO JLON2 = 1, SELF%IPROMA2
    JGLO2 = (JBLK2 - 1) * IPROMA2 + JLON2
    JGLO1 = 1 + MODULO (JGLO2-1, IGPTOT1)
    JBLK1 = (JGLO1+IPROMA1-1) / IPROMA1
    JLON1 = 1 + MODULO (JGLO1-1, IPROMA1)
