...
IF (LRADLWM5) THEN
  ...
  ALLOCATE (ZTMP2, MOLD=YD%RADLWM5)
  READ (KLUN) ZTMP2
  YD%RADLWM5 = ZTMP2
  DEALLOCATE (ZTMP2)
ELSE
...
IF (LTGWDWMSU) THEN
  ...
  ALLOCATE (ZTMP2, MOLD=YD%TGWDWMSU)
  READ (KLUN) ZTMP2
  YD%TGWDWMSU = ZTMP2
  DEALLOCATE (ZTMP2)
ELSE
...
IF (LTGWDWMSU5) THEN
  ...
  ALLOCATE (ZTMP2, MOLD=YD%TGWDWMSU5)
  READ (KLUN) ZTMP2
  YD%TGWDWMSU5 = ZTMP2
  DEALLOCATE (ZTMP2)
ELSE
...
IF (LTGWDWMSV) THEN
  ...
  ALLOCATE (ZTMP2, MOLD=YD%TGWDWMSV)
  READ (KLUN) ZTMP2
  YD%TGWDWMSV = ZTMP2
  DEALLOCATE (ZTMP2)
ELSE
...
IF (LTGWDWMSV5) THEN
  ...
  ALLOCATE (ZTMP2, MOLD=YD%TGWDWMSV5)
  READ (KLUN) ZTMP2
  YD%TGWDWMSV5 = ZTMP2
  DEALLOCATE (ZTMP2)
ELSE
