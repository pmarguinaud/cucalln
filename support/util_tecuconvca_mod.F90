...
IF (LRCUCONVCA) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%RCUCONVCA)
  READ (KLUN) ZTMP1
  YD%RCUCONVCA = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LRNLCONVCA) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%RNLCONVCA)
  READ (KLUN) ZTMP1
  YD%RNLCONVCA = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LRCAPECONVCA) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%RCAPECONVCA)
  READ (KLUN) ZTMP1
...
IF (LRWASALIVE) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%RWASALIVE)
  READ (KLUN) ZTMP1
  YD%RWASALIVE = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LRWGHTCU) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%RWGHTCU)
  READ (KLUN) ZTMP1
  YD%RWGHTCU = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LRLATLONNBLS) THEN
  ...
  ALLOCATE (ZTMP3, MOLD=YD%RLATLONNBLS)
  READ (KLUN) ZTMP3
...
IF (LRLATLONNBSS) THEN
  ...
  ALLOCATE (ZTMP4, MOLD=YD%RLATLONNBSS)
  READ (KLUN) ZTMP4
  YD%RLATLONNBSS = ZTMP4
  DEALLOCATE (ZTMP4)
ENDIF
ALLOCATE (ZTMP2, MOLD=YD%RPROB_SURVIVE)
READ (KLUN) ZTMP2
YD%RPROB_SURVIVE = ZTMP2
DEALLOCATE (ZTMP2)
ALLOCATE (ZTMP2, MOLD=YD%RPROB_BIRTH)
READ (KLUN) ZTMP2
YD%RPROB_BIRTH = ZTMP2
DEALLOCATE (ZTMP2)
ALLOCATE (ZTMP1, MOLD=YD%RPROB_FUN_FERT_S)
READ (KLUN) ZTMP1
YD%RPROB_FUN_FERT_S = ZTMP1
DEALLOCATE (ZTMP1)
ALLOCATE (ZTMP1, MOLD=YD%RPROB_FUN_UW_DW_S)
READ (KLUN) ZTMP1
YD%RPROB_FUN_UW_DW_S = ZTMP1
DEALLOCATE (ZTMP1)
ALLOCATE (ZTMP1, MOLD=YD%RPROB_FUN_FERT_B)
READ (KLUN) ZTMP1
YD%RPROB_FUN_FERT_B = ZTMP1
DEALLOCATE (ZTMP1)
ALLOCATE (ZTMP1, MOLD=YD%RPROB_FUN_UW_DW_B)
READ (KLUN) ZTMP1
...
IF (LRLONDEP) THEN
  ...
  ALLOCATE (ZTMP3, MOLD=YD%RLONDEP)
  READ (KLUN) ZTMP3
  YD%RLONDEP = ZTMP3
  DEALLOCATE (ZTMP3)
ENDIF
...
IF (LRLATDEP) THEN
  ...
  ALLOCATE (ZTMP3, MOLD=YD%RLATDEP)
  READ (KLUN) ZTMP3
  YD%RLATDEP = ZTMP3
  DEALLOCATE (ZTMP3)
ENDIF
...
IF (LSLDLONG) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%SLDLONG)
  READ (KLUN) ZTMP1
  YD%SLDLONG = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
...
IF (LSLDDLAT) THEN
  ...
  ALLOCATE (ZTMP1, MOLD=YD%SLDDLAT)
  READ (KLUN) ZTMP1
  YD%SLDDLAT = ZTMP1
  DEALLOCATE (ZTMP1)
ENDIF
